...
import com.fbasegizi.statusgizi.makan.RekomendasiHarian;
...
public class RecyclerViewRekomendasiAnak extends RecyclerView.Adapter<RecyclerViewRekomendasiAnak.ViewHolder> {

    private Context context;
    private List<Anak> anaks;

    public RecyclerViewRekomendasiAnak(Context context, List<Anak> anaks) {
