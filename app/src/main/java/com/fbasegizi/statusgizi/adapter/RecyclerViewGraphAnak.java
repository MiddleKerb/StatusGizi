...
import com.fbasegizi.statusgizi.graph.GraphChoose;
...
public class RecyclerViewGraphAnak extends RecyclerView.Adapter<RecyclerViewGraphAnak.ViewHolder> {

    private Context context;
    private List<Anak> anaks;

    public RecyclerViewGraphAnak(Context context, List<Anak> anaks) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, GraphChoose.class);
