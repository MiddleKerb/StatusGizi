...
public class RecyclerViewHitungAnak extends RecyclerView.Adapter<RecyclerViewHitungAnak.ViewHolder> {

    private Context context;
    private List<Anak> anaks;

    public RecyclerViewHitungAnak(Context context, List<Anak> anaks) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, GiziCount.class);
