...
import com.fbasegizi.statusgizi.child.EditAnak;
...
public class RecyclerViewDaftarAnak extends RecyclerView.Adapter<RecyclerViewDaftarAnak.ViewHolder> {

    private Context context;
    private List<Anak> anaks;

    public RecyclerViewDaftarAnak(Context context, List<Anak> anaks) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, EditAnak.class);
